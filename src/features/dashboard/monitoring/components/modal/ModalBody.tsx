...
const ModalDetailHeader = () => {
	return (
		<div className="grid grid-cols-3 gap-2">
			<CardInfo title="Hectáreas" value="620" unit="ha" variant="subtle" textVariant="default" />
			<CardInfo title="Monto" value="$26.5M" variant="subtle" textVariant="amount" />
			<CardInfo title="Riesgo" value="Medio" variant="high" textVariant="high" />
		</div>
	);
};
