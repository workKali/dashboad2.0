...
import { RiskDistributionBar, RiskDetailBar } from "./BarDistributionTemplate"
    ...
    return (
        <CardInfo>
            ...
            <div className="flex flex-wrap gap-2">
                <RiskDetailBar label="Bajo" percentage={20} variant="low" money="$236.2M" />
                <RiskDetailBar label="Medio" percentage={30} variant="medium" money="$446.9M" />
                <RiskDetailBar label="Alto" percentage={50} variant="high" money="$206.8M" />
            </div>
            ...
            <div className="flex items-start justify-between gap-2">
                <RiskDetailBar label="Ganadería" percentage={58} variant="low" money="$236.2M" containerClassName="flex-wrap" />
            ...
            <RiskDistributionBar data={[{ label: "Bajo", value: "$236.2M", percentage: 20, color: "bg-[#16a34a]" }, { label: "Medio", value: "$446.9M", percentage: 30, color: "bg-amber-500" }, { label: "Alto", value: "$206.8M", percentage: 50, color: "bg-red-500" }]} />
            <div className="flex items-start justify-between gap-2">
                <RiskDetailBar label="Cultivos" percentage={58} variant="crop" money="$236.2M" badgeClassNames="bg-[#3b82f618] text-[#3b82f6]" />
                <div className="flex flex-wrap gap-2 justify-end">
                    <RiskDetailBar label="Bajo" percentage={20} variant="low" money="$236.2M" />
                    <RiskDetailBar label="Medio" percentage={30} variant="medium" money="$446.9M" />
                    <RiskDetailBar label="Alto" percentage={50} variant="high" money="$206.8M" />
