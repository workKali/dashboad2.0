...
const CardHighRisk = () => {
    return (
        <CardInfo topBorder="bg-error" className="border-red-200 flex flex-col gap-2">
            <p className="text-error text-10 font-semibold uppercase tracking-wider">En alto riesgo</p>
            ...
            <div className="flex flex-col mt-1.5 gap-0.75">
                <p className="text-red-400 font-bold text-10 uppercase tracking-wider">Mayor riesgo por monto</p>
                <ItemList />
                <ItemList />
                <ItemList />
